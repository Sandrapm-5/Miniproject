...
if(isset($_POST["submit"])){
	...
	$result=mysqli_query($con,"INSERT INTO `place_tb`( `place_name`,`pdiscription`,`image`) VALUES ('$place_name','$pdiscription','$image')");
	}
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="book-form">
			    ...
			    <form action="#" method="post">
					...
					<div class="form-date-w3-agileits">
						...
						<div class="form-agileits-2">
							<input type="text" name="pdiscription" placeholder="Enter a discription" required="">
						</div>
						<div class="clear"> </div>
					</div>
                              <div class="form-date-w3-agileits">
