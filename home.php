				...
				<div class="container">
					<div class="navbar-header page-scroll">
						<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
							<span class="sr-only">Let's go</span>
							<span class="icon-bar"></span>
							<span class="icon-bar"></span>
							<span class="icon-bar"></span>
						</button>
						<h1><a class="navbar-brand" href="home.php">Let's Go</a></h1>
					</div> 
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav navbar-right cl-effect-15">
							...
							<br>
							<br>
							<ul class="nav navbar-nav navbar-left cl-effect-30">
							<!-- Hidden li included to remove active class from about link when scrolled up past about section -->
							<li class="hidden"><a class="page-scroll" href="#page-top"></a>	</li>
							<li><a href="hotel/stays.php">stays</a></li>
							<li><a  href="flight.php">Flights</a></li>
                            <li><a href ="car.php" href="cars">cars</a></li>
							<li><a href="Trainpage/train.php">Train</a></li>
		...
		<div class="w3-banner-head-info">
				<div class="container">
				   ...
				   <span class="fa fa-plane" aria-hidden="true"></span>
						<h2 class="editContent">Explore The World</h2>
	...
	<div class="container">  
		<div class="w3ls-title"> 
			...
			<div class="col-md-4 about-top">
				<h4>Welcome to Let's GO</h4>
				<h5>Let's Go</h5>
				<p>Let's go travels is a trusted tavel and tourism website provide trused customer service, clear pricing without hidden,excellent offers and packages,
					 fees explore the world in a single website.</p>
...
<p>We facilitate hundreds of thousands of transactions every day through our secure platform, and work to the highest standards to guarantee your privacy</p>
			...
			<div class="agileinfo-about-grid text-center">	
				<div class="col-md-4 col-xs-6 w3ls-about-grid">
					...
					<h6>service1</h6>
					<p>efficient and trusted tourist guied</p> 
				</div>
				...
				<div class="col-md-4 col-xs-6 w3ls-about-grid">
					...
					<h6>service3</h6>
					<p>clear pricing without hidden fees</p> 
		        </div>
				<div class="clearfix"></div>
			</div>
	</div>	
			...
			<div class="contact_wthreerow agileits-w3layouts">
				...
				<div class="col-md-5 agileits_w3layouts_contact_gridl">
					<div class="agileits_mail_grid_right_grid">
						<h4>Contact Info</h4>
						<p>Trusted and efficent customer service 24/7</p>
		...
		<div class="container">
			<div class="footer-btm-agileinfo">
				<div class="col-md-3 col-xs-3 footer-grid w3social">
					<h3>About us</h3>
					<p class="footer-p1">Let's go travels is a trusted tavel and tourism website provide trused customer service, clear pricing without hidden,excellent offers and packages,
					 fees explore the world in a single website </p>
